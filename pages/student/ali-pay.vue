  ...
  <view class="pay-container">
    <view class="pay-card">
      <view class="ali-header">
        ...
        <text class="ali-title">支付宝扫码支付</text>
      </view>
      ...
      <view class="qr-wrapper">
        <image class="qr-code" src="/static/images/ali_qr.png" mode="aspectFit"></image>
      </view>
      <view class="pay-tips">
        <view class="scan-icon">🔍</view>
        <text>请使用手机支付宝“扫一扫”<br/>扫描二维码完成安全支付</text>
      </view>
...
export default {
  ...
  methods: {
    completePayment() {
      ...
      setTimeout(() => {
        uni.reLaunch({ url: '/pages/student/profile' });
      }, 1200);
    }
  }
}
...
.ali-header { display: flex; align-items: center; justify-content: center; gap: 12rpx; margin-bottom: 30rpx; }
.ali-icon { font-size: 36rpx; }
.ali-title { font-size: 32rpx; font-weight: bold; color: #108ee9; }
...
.success-done-btn { background-color: #108ee9; color: #ffffff; border-radius: 50rpx; font-size: 28rpx; font-weight: bold; height: 84rpx; line-height: 84rpx; width: 100%; border: none; box-shadow: 0 6rpx 20rpx rgba(16,142,233,0.3); }
</style>